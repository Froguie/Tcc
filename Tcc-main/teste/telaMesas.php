...
<body class="bg-orange-300">
    <nav class="bg-black border-gray-200">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <!-- Texto da conta exibindo o nome da sessão -->
    ...
    <div class="container mx-auto p-4">
        <h1 class="text-3xl font-bold mb-6">Tela de Mesas</h1>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php foreach ($mesas as $mesa): ?>
                <div class="bg-black shadow-md rounded-lg p-4 border-gray-200">
                    ...
                    <div class="mt-4">
                        <a href="mesa.php?numero=<?= $mesa['numero'] ?>" class="bg-orange-300 text-white px-4 py-2 rounded-md hover:bg-orange-400">Gerenciar</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
